  ...
  const reasons = [
    {
      ...
      description: "Kami menggunakan teknologi kecerdasan buatan terbaru untuk memberikan deteksi ancaman yang akurat dan cepat.",
      icon: (
    ...
    },
    {
      ...
      description: "Database ancaman kami terus diperbarui untuk melindungi Anda dari jenis penipuan dan ancaman terbaru.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Kami memprioritaskan keamanan data Anda dengan enkripsi end-to-end dan perlindungan privasi yang ketat.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Dukungan 24/7",
      description: "Tim dukungan kami siap membantu Anda dengan pertanyaan atau masalah keamanan kapan saja.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {reasons.map((reason, index) => (
            ...
            >
              <div className="flex-shrink-0 mr-4 text-primary-blue">
                {reason.icon}
              </div>
              <div>
